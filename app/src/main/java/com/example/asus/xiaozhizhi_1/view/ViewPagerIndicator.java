...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private int mInitTranslationX=10;// 第一个三角形初始化的偏移位置
    private int mTranslationX;// 移动时候的三角形偏移位置
    private int mTabVisibleCount;// 可见tab的数量
    private static final int COUNT_DEFAULT_TAB = 6;// 默认可见tab为6个
    private List<String> mTitles;// 接收传递过来的title
    private static final int COLOR_TEXT_NORMAL = Color.parseColor("lightgray");
    private static final int COLOR_TEXT_HIGHLIGHT = Color.parseColor("red");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Log.e("dispatchDraw:","mTranslationX:"+mTranslationX);
        canvas.drawLine(mInitTranslationX,getHeight()-6,mTriangleWidth-(mInitTranslationX*3),getHeight()-6,mPaint);
